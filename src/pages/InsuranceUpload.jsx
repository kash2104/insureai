          ...
          >
            ...
            >
              ...
              >
                ...
                />
                <UploadIcon className={`w-12 h-12 mb-4 ${isDragging ? 'text-blue-500 dark:text-blue-400' : 'text-neutral-400 dark:text-neutral-500'}`} />
                {selectedFile ? (
                  <div className="text-center">
                    <p className="text-sm font-medium text-green-600 dark:text-green-400">File Selected:</p>
                    <p className="text-xs text-neutral-600 dark:text-neutral-300 break-all">{selectedFile.name}</p>
                  </div>
                ) : (
                  <p className={`text-sm text-center ${isDragging ? 'text-blue-600 dark:text-blue-300' : 'text-neutral-500 dark:text-neutral-400'}`}>
                    Drag & drop your file here, or{" "}
                ...
                <p className="mt-2 text-xs text-neutral-400 dark:text-neutral-600">Max file size: 5MB</p>
              </div>
            </BackgroundGradient>
